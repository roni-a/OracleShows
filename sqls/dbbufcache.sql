...
col lgcrd	for 999,999,999,999,999	head "Logical Reads  "
col phyrd 	for 999,999,999,999	head "Physical Reads"
col phywr	for 99,99,999,999		head "Physical Writes"
col hrt		for 99.9999		head "Buffer   |Hit Ratio"

SELECT 	a.value + b.value lgcrd, 
	c.value phyrd, 
	d.value phywr,
