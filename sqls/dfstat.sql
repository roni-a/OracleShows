...
col phywrts	for 999,999,999 trunc 	head "Phy Writes"
col phyrds	for 999,999,999,999 trunc	head "Phy Reads"  
col blkwr	for 999,999.99 trunc	head "Block|Wr/ms"
col blkrd	for 999,999.99 trunc	head "Block|Rd/ms"
