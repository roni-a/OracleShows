...
SELECT sess.sid, sess.serial#, sess.username, substr(conn.osuser,1,10) osuser, 
...
FROM v$session sess, v$sesstat stat, v$statname name , v$process proc, v$session_connect_info conn
